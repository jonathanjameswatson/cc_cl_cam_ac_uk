...
%token WHAT UNIT AND TRUE FALSE IF FI THEN ELSE LET REC IN BEGIN END BOOL INTTYPE UNITTYPE EMPTYLIST
%token ARROW BAR INL INR FST SND FUN NUF CASE OF REF ASSIGN BANG WHILE DO OD LIST
...
| expr CONS expr                     { Past.Op(get_loc(), $1, Past.CONS, $3) }
...
| FUN LPAREN IDENT COLON texpr COMMA IDENT COLON texpr RPAREN ARROW expr END
